...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_weather_forecast_forecast_time'), 'weather_forecast', ['forecast_time'], unique=False)
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(op.f('ix_weather_forecast_forecast_time'), table_name='weather_forecast')
